...
More information can be found in the [pkg/github.com/senzing-garage/serve-http/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing-garage/serve-http/anotherpackage"
	)
